    ...
    for rr in risk_engine_records:
        ...
        issues.append(
            PotentialIssueItem(
                issue=title,
                explanation=getattr(
                    rr, "plain_language_explanation", getattr(rr, "finding", title)
                ),
                potential_impact=getattr(
                    rr, "why_it_matters", "This clause may affect your rights or obligations."
                ),
        ...
        issues.append(
            PotentialIssueItem(
                ...
                potential_impact=getattr(
                    mp,
                    "why_it_matters",
                    "This absent clause may leave you without legal protection.",
                ),
